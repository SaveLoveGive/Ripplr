...
describe Ripplr::Queryable do
  ...
  describe "#indexes_as" do
    ...
    # context "when there is no key method" do
    #   Then { expect { Ripplr::Formatters::Riak.to_index(mock) }.to raise_error("Cannot index an object that does not specify a key.") }
    # end
